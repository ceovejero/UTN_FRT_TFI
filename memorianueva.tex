...
% Metadatos: hyperref convierte los caracteres UTF-8 a texto PDF.
\hypersetup{
...
% No redefinir aquí los acentos: una definición como \def\"{\"}
% es recursiva y puede bloquear la conversión de metadatos o marcadores.
