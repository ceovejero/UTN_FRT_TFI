...
1. Ir al repositorio del proyecto **TFI_FRT**, plantilla para Tesis de Grado de UTN FRT.
...
2. Completar los siguientes campos:
   ...
   - **Carrera de grado**: completar el nombre de la carrera correspondiente de UTN FRT.
